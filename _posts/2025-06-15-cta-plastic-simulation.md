...
Now that we have the restraint file ready to go, we can subject the GMML model to MD at 600 K for 10 ns in vacuum to collapse it. Here is the input file that will do this using sander in the AMBER software suite:
...
[4] Hamid M. Shaikh, Arfat Anis, Anesh M. Poulose, Saeed M. Al-Zahrani, Niyaz A. Madhar, Abdullah Alhamidi, Saleh H. Aldeligan, and Faisal S. Alsubaie. 2022. Synthesis and Characterization of Cellulose Triacetate Obtained from Date Palm (Phoenix dactylifera L.) Trunk Mesh-Derived Cellulose. Molecules 27, 4, https://doi.org/ 10.3390/molecules27041434.
